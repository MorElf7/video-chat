...
const RoomSettingWindow = dynamic(
  () => import("@/components/RoomSettingWindow"),
);
...
export default function Home() {
  ...
  const roomsData = useSWRMutation(
    `${config.cloud.uri}/api/room/user`,
    getUserRooms,
  );
  ...
  return (
    <>
      ...
      <div className="flex min-h-[87%] max-h-[89%]" id="messages">
        ...
        <ChatWindow
          roomInfo={roomInfo}
          handleCallStartModal={handleCallStartModal}
        />
        {roomSetting && (
          <RoomSettingWindow
            roomInfo={roomInfo}
